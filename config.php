...
define("NAME", "GIANG HO"); //This app's name.
...
define("DB_NAME", "shorting_rutgon-goin"); //The database name.
define("DB_USER", "shorting_rutgon-goin"); //The database access username.
define("DB_PASS", "https://da001.vhost.vn/"); //The database access password.
define("DB_HOST", "localhost"); //The database access host.



//URL settings.
define("PATH", "rutgo"); //The sub directory in which this script runs.