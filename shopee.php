...
$aff = "?utm_source=an_17171860000&utm_medium=affiliates&utm_campaign=&utm_content=sellervn-276099513";
$result = $_GET['url'].$aff;
$subject = $result;
$search = ['https://shopee.vn/'];
$replace   = ['https://shopee.vn/universal-link/'];
$result1 = str_replace($search, $replace, $subject);

    $link = $linkity->createLink($result1);
...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Tạo link rút gọn nền tảng shopee | <?php echo htmlspecialchars($linkity->name); ?></title>
  ...
  <body>
    ...
    <img class="bg" src="https://cdn.wallpapersafari.com/68/63/Xj2JQK.jpg" alt="">



    <main class="page">
      <h1>Tạo link aff Shopee</h1>
      <!-- <p>X</p> -->
      
<form class="shorten">
          <input type="text" name="url" placeholder="Chỉ link shopee mới tạo được link aff"  value=''>
        <button>Tạo Link</button> <br><br>
